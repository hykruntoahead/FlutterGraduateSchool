...
class TextWidgetInstance extends StatefulWidget {
  TextWidgetInstance({Key key, this.title}) : super(key: key);
  final String title;
...
class _MyHomePageState extends State<TextWidgetInstance> {
  @override
  ...
  return Builder(builder: (BuildContext context) {
    ...
    final Shader linearGradient = LinearGradient(
      colors: <Color>[Colors.purple, Colors.blue],
        ...
        0.0, 0.0, box?.size?.width?.toDouble(), box?.size?.height?.toDouble()));
  ...
  return Text.rich(
    TextSpan(
        ...
        children: [
          ...
          TextSpan(text: '你好,flutter有学习前景吗?值得花精力去学吗?')
        ]),
  );
}
